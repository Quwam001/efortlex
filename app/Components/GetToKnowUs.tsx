...
const GetToKnowUs: React.FC = () => {
  return (
    <div>
      <div>
        <div
          className="px-6 py-10 grid grid-cols-1 text-center gap-10 md:px-20 py-5 md:grid-cols-2 md:gap-0 md:items-center md:text-left lg:px-20"
          id="about">
          <center>
            <div className="">
          ...
          <div>
            ...
            <p className="custom-gray text-sm mt-1 text-left">
              ...
              challenges students face, and we&apos;re dedicated to supporting
